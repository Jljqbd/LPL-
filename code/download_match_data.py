...
class download_match_data():
    def __init__(self, response_url, match_id, teamsname, Jc, team_use_hero, Hc, Centroid_x, \
        Centroid_y, team_event, team_kill_event, dxdy, win_Hc, win_Jc, win_fail_n_time, win_dxdy, \
            fail_dxdy, team_win_fail_num, isread):
        match_id = str(int(match_id))
        response_url = str(int(response_url))
        self.response_url = response_url
        self.match_id = match_id
        self.url = "https://www.wanplus.com/ajax/matchdetail/"+ match_id + "?_gtk=2083301385"
